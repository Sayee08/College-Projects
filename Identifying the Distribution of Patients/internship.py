...
def printtomap(givendata,mapping,count):

    ##SAYEE your code goes here
    ##givendata has dept,date,pincode
    ##mapping has pincode,lat,long
    ##count has pincode,frequency
    ##join these three lists and do your thing and print to map
    ##Split these into mapping based on date
    return
...
if __name__=='__main__':
    ...
    q.join()
    mapping+=tempmap
    printtomap(givendata,mapping,count)
